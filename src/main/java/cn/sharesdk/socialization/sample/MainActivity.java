...
public class MainActivity extends Activity implements Callback, OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivIllustration = (ImageView) findViewById(R.id.ivIllustration);
...
//			topicAuthor = getString(R.string.comment_like_author);
			...
			topicPublishTime = bundle.getString("topicPublishTime");
			topicAuthor = bundle.getString("topicAuthor");
			imageLoader.displayImage(bundle.getString("imageuri"), ivIllustration);
			tvText.setText(bundle.getString("content"));//详情描述
